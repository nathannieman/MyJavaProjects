         ...
         switch (selection)
         {
            ...
            case 1:
               ...
               switch (selection)
               {
                  ...
                  case 2:
                     ...
                     teacherList.stream().filter(teach -> (teacherName.equals(teach.getName()))).forEachOrdered(item ->
            ...
            case 2:
               ...
               switch (selection)
               {
                  ...
                  case 2:
                     ...
                     studentList.stream().filter(study -> (studentName.equals(study.getName()))).forEachOrdered(item ->
            ...
            case 3:
               ...
               switch (selection)
               {
                  ...
                  case 1:
                     System.out.println("Total amount earned by the school $" + School.totalMoneyEarned);
                     System.out.println();
                     break;
                     
                  //User checks amount spent by the school
                  case 2:
                     System.out.println("Total amount spent by the school $" + School.totalMoneySpent);
                     System.out.println();
                     break;
                     
                  //User checks total School money
                  case 3:
                     System.out.println("Total school money $" + School.totalMoney);
                     System.out.println();
                     break;
